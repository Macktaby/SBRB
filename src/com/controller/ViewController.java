...
public class ViewController {
	...
	public Response allTransactions() {
		try {
			return Response.ok(new Viewable("/WEB-INF/jsp/AllTransactions")).build();
		} catch (Exception e) {
			// TODO: handle exception
			e.printStackTrace();
			return null;
	...
	@Produces("text/html")
	public Response filterTransactions() {
		try {
			return Response.ok(new Viewable("/WEB-INF/jsp/FilterTransactions")).build();
		} catch (Exception e) {
			// TODO: handle exception
			e.printStackTrace();
			return null;
